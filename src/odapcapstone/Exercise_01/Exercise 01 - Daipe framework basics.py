...
@dp.transformation(
    dp.read_csv(data_source_path + "/transactions_2022-06-06.csv", options=dict(header=True)),
    display=True
)
...
def join_customers_and_transactions(first_df, second_df):
    return first_df.join(second_df, on="id")
