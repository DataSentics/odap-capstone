...
@dp.transformation(dp.read_table("odap_academy_ondrejlostakdatasenticscom.customer_transactions_sdm"))
...
def more_than_two_transactions_last_year_flag(df):
    return (
        ...
        .withColumn("more_than_two_transactions_last_year_flag",sf.col("count")>2)
        .drop("count")
    )
